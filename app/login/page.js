        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-6 w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 hover:bg-gray-50 px-4 py-3 rounded-md font-semibold transition-colors"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Нямате профил?{' '}
              <Link href="/register" className="text-brand-green hover:text-brand-green-dark font-semibold">
                Регистрирайте се
              </Link>
            </p>
          </div>
